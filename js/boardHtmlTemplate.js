            ...
            <form class="add-task-form" id="form" onsubmit="validateForm();return false">
                ...
                <div class="input-container">
                    ...
                    <label
                      for="urgent"
                      class="radio-button"
                      onclick="invertSvgFills('urgent'); handleClick('urgent')"
                      >Urgent
                      <svg
                        id="urgent-icon"
                        width="21"
                    ...
                    <label
                      for="medium"
                      class="radio-button"
                      onclick="invertSvgFills('medium');handleClick('medium')"
                      >Medium
                      <svg
                        id="medium-icon"
                        width="21"
        ...
        <div class="task-overlay-edit-content">
          ...
          <div class="input-container">
            ...
            <div class="add-subtask">
              ...
              <div id="subTaskSvgContainer" class="svg-container">
                <svg class="svg-plusicon" id="subTaskPlusIcon" width="25" height="24" viewBox="0 0 25 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
