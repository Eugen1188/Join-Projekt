            ...
            <form class="add-task-form" id="form" onsubmit="validateForm();return false">
                ...
                <div class="input-container">
                    ...
                    <div id="prio" class="prio-container">
                        ...
                        <label for="urgent" class="radio-button">Urgent
                            <svg id="urgent-icon" width="21" height="16" viewBox="0 0 21 16" fill="none"
                        ...
                        <label for="medium" class="radio-button">Medium
                            <svg id="medium-icon" width="21" height="8" viewBox="0 0 21 8" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <label for="low" class="radio-button">Low
                        <svg id="low-icon" width="21" height="16" viewBox="0 0 21 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="input-container">
                    ...
                    <input class="input-addtask" id="subtask" type="text" onkeyup="getInput()" />
                        <div class="svg-container">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            onclick="pushSubtask()">
                            <mask id="mask0_136369_4669" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="25" height="24">
                                <rect x="0.248535" width="24" height="24" fill="#D9D9D9" />
                            </mask>
