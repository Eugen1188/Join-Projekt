...
function renderSubtaskInputIcons() {
  return `
    <div class="changed-input-icons">
      <svg onclick="clearSubtaskInput()" class="pointer icon" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg class="pointer icon" onclick="pushSubtask()" width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
